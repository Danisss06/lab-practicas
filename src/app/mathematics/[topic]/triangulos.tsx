...
const TriangulosPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <p className="mt-4 font-bold">Teorema</p>
      <p>La suma de los tres ángulos de cualquier triángulo es igual a 180º.</p>
      <p className="mt-4 font-bold">Triángulo rectángulo</p>
      <p>
        Es aquel que tiene un ángulo que mide 90º. El ángulo de 90º se
        representa:
      </p>
      ...
      <p className="mt-4">
        <span className="font-bold">Instrucciones:</span> calcular la medida que
        se pide.
      </p>
